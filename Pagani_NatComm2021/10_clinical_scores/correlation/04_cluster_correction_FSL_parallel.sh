...
#  outfile1=cluster_"$stub"_t"$tval"_p"$pval"_pos.txt
#  outfile2=cluster_extra_"$stub"_t"$tval"_p"$pval"_pos.txt
  ccimg_pos=rm.cc_pos
  ...
  cluster -i $sub \
          ...
          --mm \
          --minclustersize \
#          --olmax=$outfile2 > $outfile1

  ## get cluster stats for negative correlations

#  outfile1=cluster_"$stub"_t"$tval"_p"$pval"_neg.txt
#  outfile2=cluster_extra_"$stub"_t"$tval"_p"$pval"_neg.txt
  ccimg_neg=rm.cc_neg
