...
connectivity_maps_path=/media/DATA1/IIT_17Sep_Tsc2/01_rsfMRI_human_ABIDE1_Lombardo/05_younger_than_13yo/02_global_connectivity/01_gbcmaps/ # edit this, path of single subject connectivity maps
two_sample=$PWD/02a_t-test_and_cohens_d_single_site/

mkdir $two_sample

sites=(KKI NYU Oregon Stanford UCLA UM_1 Yale_scans)
...
for site in "${sites[@]}"; do
 ...
 # carries out t-test
    ...
    3dttest++ \
        -setA $connectivity_maps_path/${site}*_${groupA}_*.nii.gz \
        -setB $connectivity_maps_path/${site}*_${groupB}_*.nii.gz \
