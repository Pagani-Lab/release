...
path_dicom=/media/DATA1/22q11_human/02_dicom/Trio/ # edit this, path where dicom files are located
extracted_path=03_extracted_Trio  # edit this, path where files.nii.gz will be extracted
...
function dicom2nifti {
	...
	/home/imaging/tools/mricron/dcm2nii -4 ${ts}/*RESTING*/*
	cp ${ts}/*RESTING*/*RESTING*.nii.gz $extracted_path/${subject}/rest.nii.gz

	rm ${ts}/*MPRAGE*/*.nii.gz
	rm ${ts}/*RESTING*/*RESTING*.nii.gz
